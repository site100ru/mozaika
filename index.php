	...
	<div class="container">
		<div class="row align-items-center home-section-height">
			<div class="col-xl-10 col-xxl-9">
				<h1 class="home-title mb-3">Корпусная мебель По индивидуальным размерам на заказ от производителя</h1>
				<p class="home-subtitle mb-4">Изготовим качественную корпусную мебель с учетом Ваших пожеланий и особенностей помещения по разумной цене! Рассчитаем стоимость за 15 минут.</p>
	...
	<div class="container">
		...
		<div class="row text-start">
			<div class="col-md-6 mb-5">
				<a href="https://мозаика62.рф/кухни-на-заказ/">
					<div class="approximation project-container-2 services">
						<img src="<?php echo get_template_directory_uri(); ?>/img/kitchen.webp" class="img-fluid" alt="">
			...
			<div class="col-md-6 mb-5">
				<a href="https://мозаика62.рф/шкафы-на-заказ/">
					<div class="services approximation project-container-2">
						<img src="<?php echo get_template_directory_uri(); ?>/img/wardrobe.webp" class="img-fluid" alt="" decoding="async" />
						<div class="card-wrapper project-container-2-footer">
							<div class="row" style="height: 100%;">
								<div class="col-6">
...
<?php get_template_part('template-parts/section-portfolio-tabs/section-portfolio-tabs', null, array(
    'category' => 'all',
    'section_title' => 'Последние выполненные работы',
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-5 text-md-end">
				...
				<p class="section-description archive-portfolio mb-3">Узнайте стоимость качественной кухни с учетом всех Ваших пожеланий и особенностей помещения. Оставьте заявку нажав на кнопку ниже или напишите нам в мессенджер. Это бесплатно и ни к чему Вас не обязывает!</p>
				...
				<div class="row justify-content-md-end">
					<div class="col">
						<ul class="nav justify-content-md-end mt-4">
							<li class="nav-item">
								<a class="nav-link ico-button px-2" href="<?php echo esc_url($whatsapp); ?>" target="_blank">
							...
							<li class="nav-item">
								<a class="nav-link ico-button px-2" href="<?php echo esc_url($max_link); ?>" target="_blank">
				...
				<div class="accordion text-start" id="accordionExample">
						...
						<div id="collapse-2" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								...
								<ul class="mb-0">
									...
									<li>написать на электронный адрес: <a style="text-decoration: none;" target="_blank" href="mailto:<?php echo esc_attr(mytheme_get_email()); ?>" itemprop="email"><b><?php echo esc_html(mytheme_get_email()); ?></b></a>;</li>
									<li>позвонить по телефону ☎ <a href="tel:<?php echo esc_attr($main_phone_link); ?>" style="text-decoration: none;"><b><?php echo esc_html($main_phone); ?></b></a>;</li>
					...
					<div class="accordion-item mb-3">
						...
						<div id="collapse-4" class="accordion-collapse collapse" aria-labelledby="heading-4" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<p>Конечно!</p>
								<p class="mb-0">Направьте эскиз с Вашей кухней (или другой корпусной мебелью) на нашу электронную почту: <a style="text-decoration: none;" target="_blank" href="mailto:<?php echo esc_attr(mytheme_get_email()); ?>" itemprop="email"><b><?php echo esc_html(mytheme_get_email()); ?></b></a>, дополнительно указав в письме материал фасадов, комплектацию, габариты мебели и мы предоставим расчет в ответном письме.</p>
							</div>
						</div>
					</div>
					<div class="accordion-item mb-3">
