	...
	<div class="container py-5 d-none d-xl-block">
		<div class="row align-items-center">
			...
			<div class="col-xl-2 text-end">
				<a href="tel:<?php echo esc_attr(mytheme_get_phone_link('main')); ?>" class="contacts-phone">
					<img src="<?php echo get_template_directory_uri(); ?>/img/ico/mobile-phone-ico.svg" class="me-2" style="position: relative; bottom: 1px;"><?php echo esc_html(mytheme_get_phone('main')); ?>
				</a>
			</div>
			<?php endif; ?>
		</div>
	...
	<div class="container d-xl-none">
		<div class="row">
			<div class="col py-5">
				...
				<a href="tel:<?php echo esc_attr(mytheme_get_phone_link('additional')); ?>" class="contacts-phone">
					<div style="display: flex;" class="align-items-center">
						<div class="nav-li-float-left">
				...
				<ul class="nav pt-4 pb-3">
					<?php if (mytheme_get_whatsapp()) : ?>
					<li class="nav-item">
						<a class="nav-link ico-button ps-0 pe-2" href="<?php echo esc_url(mytheme_get_whatsapp()); ?>">
							<img src="<?php echo get_template_directory_uri(); ?>/img/ico/whatsapp-ico.svg">
						</a>
					</li>
					<?php endif; ?>
